...
import { composeRefs, mergeProps } from '../utils/slot';
...
export const Slot = React.forwardRef<any, SlotProps>((props, ref) => {
  ...
  if (slottable) {
    ...
    const newChildren = childrenArray.map(child => {
      ...
      if (React.isValidElement(newElement)) return newElement.props.children;
      else console.warn('Slot component should have only one React element as a child');
